...
export const GisMapLegend: React.FC = () => {
  return (
    <div className="absolute bottom-4 left-4 z-10 bg-white/95 backdrop-blur-md shadow-lg border border-slate-200 rounded-2xl p-3 text-[11.5px] text-slate-700 space-y-2 pointer-events-auto min-w-56">
